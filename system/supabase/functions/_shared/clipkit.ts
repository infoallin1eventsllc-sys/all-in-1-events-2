...
export function buildComposition(set: SceneSet, script: VideoScript, aspect: "9:16" | "16:9", music?: string) {
  ...
  elements.push({
    ...
    elements: [
      ...
      { id: "wm-3", type: "text", layer: 3, time: tw + 0.8, duration: "end", x: 0, y: H * 0.40 + (portrait ? 160 : 176), width: W, height: 44, text: "Here at Meridian, we put the future in your hands.", style: "kicker", fill_color: "#93C5FD", font_weight: 600, letter_spacing: 0.5,
        font_size: portrait ? 24 : 30, text_align: "center", animations: [{ type: "fade-in", time: "start", duration: 0.5 }] },
