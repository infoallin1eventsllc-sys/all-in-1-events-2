...
//
// RECOVERED 2026-09-01: this file and pay-webhook existed only as a deployed
// Supabase function and had never been committed. See the runauth.ts recovery
// for why that is dangerous — a redeploy from repo source silently reverts
// anything the repo does not know about.
