 ...
 * changing anything: lab/hero.html (Ember, a sample aircraft), #classic or
 * ?look=classic for the hero as shipped. The app itself is untouched.
 */
type Look = 'ember' | 'classic';
const initial = (): Look => (location.hash === '#classic' || new URLSearchParams(location.search).get('look') === 'classic' ? 'classic' : 'ember');
