...
const PILLARS = [
  ...
  { icon: <Database />, title: 'Every second of every flight is recorded', plain: 'Where each aircraft was, what it saw and what it was told — the record for your insurer or an investigation.', technical: 'Time-series storage at 10,000+ writes/sec · layer 08' },
